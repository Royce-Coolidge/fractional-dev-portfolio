  ...
  return (
    <>
      <ProjectContainer className={styles.uses}>
        ...
        <ProjectHeader
          title="Uses"
          description="A somewhat comprehensive list of tools, apps, hardware, and more that I use on a daily basis to design and code things. And yeah, that is a peep show GIF of Mark showing off his ergonomic management keyboard in the background."
        />
          ...
          <ProjectSectionContent>
            <ProjectTextRow width="m">
              ...
              <ProjectSectionText as="div">
                <List>
                  <ListItem>
                    I use <Link href="https://code.visualstudio.com/">VS Code</Link> as my text
                  ...
                  <ListItem>
                    ...
                    learning curve but you can do some really cool stuff with it.
                  </ListItem>
                  ...
                  <ListItem>
                    For eccommerce websites I use{' '}
                    <Link href="https://shopify.com/">Shopify</Link>.
                    Its a great platform for building eccommerce websites quickly and easily.
                  </ListItem>
                  <ListItem>
              ...
              <Table>
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell>iMac M4 24"</TableCell>
                  </TableRow>
                  <TableRow>
                  ...
                  <TableRow>
                    ...
                    <TableCell>1440p IPS 144hz DELL U2412M</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableHeadCell>Keyboard</TableHeadCell>
                    <TableCell>Apple Magic Keyboard</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableHeadCell>Mouse</TableHeadCell>
                    <TableCell>Apple Mouse</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableHeadCell>Laptop</TableHeadCell>
                    <TableCell>Macbook Air M2 13"</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableHeadCell>Headphones</TableHeadCell>
                    <TableCell>Sony WH-1000XM4/Apple Airpods</TableCell>
                  </TableRow>
                  <TableRow>
